...
internal sealed class MainHudUiController
{
    ...
    public void PopulateTopBarSettings(HudController.OptionSettingsData settings) => _topBarController.PopulateSettings(settings);
    ...
    public void PopulateLogSettings(HudController.OptionSettingsData settings) => _logPanelController.PopulateSettings(settings);
