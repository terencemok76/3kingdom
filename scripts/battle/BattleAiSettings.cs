...
internal static class BattleAiSettings
{
    ...
    internal const int AiBridgeCongestionThreshold = 2;
    internal const int AiBridgeCongestionScore = 700;
    ...
    internal const int AiGateRepairBaseScore = 1200;
    internal const int AiGateRepairWorkerBonus = 350;
    ...
    internal const int AiCommandRadius = 8;
    internal const int AiUncommandedSupportIntelligence = 50;
