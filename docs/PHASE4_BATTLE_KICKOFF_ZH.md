...
19. **已完成—外交目標關係值**：外交面板的「目標勢力」下拉清單在每個勢力名稱後顯示目前關係值（正值附 `+`）與關係狀態，例如「劉焉｜關係 +35｜同盟」，使玩家可在提出同盟、停戰或其他外交行動前比較目標。

20. **已完成—使者與賞賜人選能力比較**：外交使者選擇表顯示城市、狀態、忠誠、魅力、智力及政治；年齡與統率不屬外交選派的判斷資料，故不顯示。賞賜武將選擇表顯示職務、任命、城市、狀態、年齡、忠誠與全部能力。兩者均沿用共用表格的欄位標題排序，故可按忠誠或所需能力比較後再選人。
